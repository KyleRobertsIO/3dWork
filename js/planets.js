...
function update(renderer, scene, camera, controls){
    ...
    planetOrbit(scene, "mercury", timestamp, 47.9, 36); //88
    planetOrbit(scene, "venus", timestamp, 35, 67); //224.7
    planetOrbit(scene, "earth", timestamp, 29.8, 141); //365.3
    planetOrbit(scene, "mars", timestamp, 24, 438); //687
    planetOrbit(scene, "jupiter", timestamp, 13.1, 886); //4343.5
    planetOrbit(scene, "saturn", timestamp, 9.7, 1784); //10767.5 
    planetOrbit(scene, "uranus", timestamp, 6.8, 2794); //30660
    planetOrbit(scene, "neptune", timestamp, 5.4, 3674); //60152
